                        ...
                        <div className="relative p-4 w-full  max-w-lg h-full md:h-auto">
                            <div className="relative bg-gray-50 min-w-md  rounded-lg shadow ">
                                ...
                                <div className="p-6 text-center">
                                    <button type="button" className="bg-slate-800 text-white active:bg-slate-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150" onClick={() => { closeModal(false) }} >
                                        Okay
                                    </button>
