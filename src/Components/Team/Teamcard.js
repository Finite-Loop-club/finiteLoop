...
function Teamcard(props) {
    return (
        <>
            <Fade className="shadow-2xl hover:shadow-gray-900 hover:shadow-2xl transition duration-300 max-w-sm scale-90 lg:scale-100 h-full text-center w-[80%] lg:w-[20%] m-5 rounded-md">
