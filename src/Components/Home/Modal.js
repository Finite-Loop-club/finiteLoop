...
function Modal(props) {
    return (
        <>
            <div id="popup-modal" tabindex="-1" class="visible backdrop-blur-sm overflow-y-auto overflow-x-hidden fixed top-50 right-50  z-50 md:inset-0 h-modal md:h-full">
                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                    <div class="relative bg-white rounded-lg shadow ">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 ">{props.text}</h3>
