export const eventData = [
  {
    ...
    sponsor: "Lifestyle",
    sponsorLink: "https://lifestylestores.com/",
    smallDesc:
      "Couture is the platform to showcase unseen, unforgettable and ultimate spectacle of all things fashion.",
    fullDesc:
      "Fashion is a unique platform of art to express and impress. Couture is the platform to showcase unseen, unforgettable and ultimate spectacle of all things fashion. So gather your team, work around a theme and strut down the runway.",
    rules: [
...

  {
    ...
    smallDesc:
      "Are you a big-time foodie, a glutton who loves to eat it all in one go?",
    fullDesc:
      "For all the food-lovers with appetites bigger than their tummies, it's time to put your bellies and taste buds to test. lncridea'22 presents- Hogathon. A mega food eating competition to hog it all as fast as you can, let's see \"How Big Your Appetite is?\"",
    roundDetails: {
      Round: [
...

  {
    ...
    sponsorLink: "https://www.paramvah.com",
    smallDesc:
    ...
    fullDesc:
      "Sanskrit literature has a profound saying which goes, \"Kavyeshu Natakam Ramyam\" : Drama is the finest form of poetry. 'Drama' is a metaphorical amalgamation of visual, auditory, material, and nuances of character.",
    roundDetails: {
...

  {
    ...
    botSpecifications: [
      "Dimensions of the bot: 60cm x 60 cmx 60 cm (5% tolerance on each dimension)",
...

  {
    ...
    sponsorLink: "https://www.nrityashakti.com/",
    smallDesc:
      "A chance for all the amazing groups out there to showcase their group's skills, choreography, and sync.",
    fullDesc:
      "There is nothing more calming than watching a fluid choreography of people dancing in unison. This is a chance for all the amazing groups out there to showcase their group's skills, choreography, and sync. So get your groups ready to stomp that stage with uniqueness and talent!",
    eventDetails: {
      event: [
...

  {
    ...
    fullDesc:
      "Come join the battle of dance and ignite your dancing flame! Vibe hai toh hype hai",
    roundDetails: {
      "Round 1": [
        "Online Eliminations:",
  ...
  },
  {
    ...
    smallDesc:
      "If you want to improve your grammar skills then it's time to ditch all the books and podcasts and play some word games instead.",
    fullDesc:
      "If you want to improve your grammar skills then it's time to ditch all the books and podcasts and play some word games instead.",
    roundDetails: {
      round1: [
        "Aptitude round - A quiz to clear for qualification to the next successive round.",
      ],
      round2: [
        "Taboo round - A fun game for a player to have their partners guess the word on the player's card without using that word.",
      ],
      round3: ["Spell bee"],
    },
    ...
    rules: [
      ...
      "Using mobiles or any other gadget is not allowed",
    ],
    judgingCriteria: [
      "The participants scoring a higher number of points will qualify for successive rounds.",
    ],
    contactDetails: [
      {
        name: "Namana Gowda",
  ...
  },
  {
    ...
    rules: [
      "The event consists of 3 rounds",
      "Each team must comprise 2 members",
      "Using mobiles or any other gadget is not allowed",
    ],
    judgingCriteria: [
      "The participants scoring a higher number of points will qualify for successive rounds.",
  ...
  },
  {
    ...
    smallDesc:
      "Come entice the audience and enable them to feel closer to the Almighty, in the soothing Bhajan competition.",
    fullDesc:
      "'I'll be singing hymns to the rafters, be praising his goodness so loud they're going to have to turn down the volume in Heaven, God loves to hear you. sing, so sing.' Come entice the audience and enable them to feel closer to the Almighty, in the soothing Bhajan competition.",

    rules: [
      "Every team must consist of 5 to 8 members. A Bhajan can be sung with or without Indian musical instruments",
    ...
    judgingCriteria: [
      "The judgment is based on the quality of singing (sur, raag, and tal), involvement and synchronization (with other singers and instruments used), selection of Bhajans, dress code, creativity, and overall performances",
  ...
  },
  {
    ...
    smallDesc:
      "'The artist sees what other catch only a glimpse of', said the great Da Vinci. Come, bring your strokes alive on the canvas to create a masterpiece!",
    fullDesc:
      "In this single round event, participants will be given a topic on the spot. Pencil sketch and painting are to be submitted to the organizers within the given time.",

    rules: [
      "Any number of entries from a college are permitted",
      " Solo entries only",
      "Topics will be given on-spot",
      "Participants must get their own materials",
      "Sheets will be provided by the organizers",
      "Oil, water or poster colours (only for paintings) are permitted",
      "The decision of the judges is final and irrevocable",
    ],
    judgingCriteria: [
      "Creativity",
  ...
  },
  {
    ...
    fullDesc:
      "Are you ready to get the best reward for your fitness lifestyle? Do you think you have what it takes to be the ultimate FITNESS FREAK? Desafio is an event which checks your FITNESS level by having various rounds. The tasks would not be mentioned precisely as it would be best if kept a surprise",
    roundDetails: {
      round1: [
        "This is a mass elimination round depending on the registrations and we will have mass elimination considering their fitness levels. If there are less registrations, then the Round 1 will not be conducted.",
      ],
      round2: [
        "This round is to shortlist contestants to the FINAL SHOWDOWN.",
        "Groups of 4 will be made randomly which will be done by the organizers.",
        "The participants who played good enough will be selected. They are judges individually.",
        " It is purely based on the physical task which should be performed within the given time",
        "Task will be given to each one of the team member, The first one should complete his/her task and pass it on to the second member and it goes same till the final 4th member of the team.",
        "Number of groups depends on the registrations.",
      ],
      round3: [
        "The final round will be an intense fitness course which will decide who the WINNER is.",
        "8-10 contestants will be selected to the finals. Each of them will do the same course.",
        "It is Purely based on an intense task which should be performed within the given time also with a good form.",
        "The Participant who successfully completes the course with minimum time will be the WINNER.",
      ],
    },
    rules: [
  ...
  },
  {
    ...
    roundDetails: {
      round1: [
        "This is an mass elimination round depending on the registrations and we will have mass elimination considering their fitness levels.",
        "If there are less registrations, then the Round 1 will not be conducted.",
      ],
      round2: [
        "This round is to shortlist contestants to the FINAL SHOWDOWN.",
        "Groups of 4 will be made randomly which will be done by the organizers.",
        "The participants who played good enough will be selected. They are judges individually.",
        "It is purely based on the physical task which should be performed the given time. within the given time",
        "Task will be given to each one of the team member, The first one should complete his/her task and pass it on to the second member and it goes same till the final 4th member of the team.",
        "Number of groups depends on the registrations.",
      ],
      round3: [
  ...
  },
  {
    ...
    smallDesc:
      "In a world obsessed with the digital and NFTS, can you think on your feet and create art that burns itself into our minds as well our screens?",
    fullDesc:
      "In a world obsessed with the digital and NFTS, can you think on your feet and create art that burns itself into our minds as well our screens? Here's Digital Art Competition for you. Only solo participant. Participants will have to get their own devices (laptops, trackpad, etc). Time duration is 1 hour 30 minutes.",
    roundDetails: {
      round1: [
        "Given a topic illustrate it digitally within the time limit.",
        "Time duration is : 1 hour 30 minutes.",
      ],
    },
    rules: [
      "This event is for solo participants only.",
      "Only digital illustration art is allowed. Any form of image manipulation is strictly not allowed in this contest.",
      "Participants are required to bring their own equipment (laptops, digi-pads , tablets etc.)",
      "The decision of the judges is final and binding.",
      "Time duration of the event is 90 minutes.",
      "The topic for the competition will be informed on the spot.",
    ],
    judgingCriteria: [
      "Relevance to the theme",
      "Originality/Creativity",
      "Technical Execution and Creativity.",
      "Unity of composition and Elements",
    ],
    contactDetails: [
      {
        name: "Suhan S Nayak",
...

  {
    ...
    judgingCriteria: [
      "Performance and technicality in dance",
      "Team's choreography and originality of the idea",
      "Coordination/Synchronization",
      "Theme and Music",
      "Theme and Music",
      "Expressions will be given importance",
    ],
    "regi details": [
      "Two members form a team",
      "The team can register online prior to the event. Spot registration is also allowed",
      "The team must mention their form of dance while registering",
  ...
  },
  {
    ...
    roundDetails: {
      round1: [
        "A pen-paper test consisting of 40 questions -10 each from Money heist, general knowledge, geography, riddles. The top 12-15 teams will qualify for the next round.",
      ],
      round2: [
        "Treasure hunt Here the teams will be given 6 clues. Of those, the initial 4 will be different for each team and the remaining 2 will be common for all. The top 4-6 teams will qualify for the final round.",
      ],
    ...
    rules: [
      ...
      "Round 1 : Time duration: 40 minutes",
      "Round 2 : Time duration: 2 hours",
      "Round 3 : Time duration: 2 hours and 15 minutes ",
      "Only students pursuing engineering degrees are allowed to participate.",
      "A maximum of 4 members are allowed in a team. ",
      "All the team members must be from the same college.",
      "External contestants should register prior. Spot registrations are notentertained.",
      "Internal contestants are also advised to register prior to the event, although spot registrations are accepted.",
    ],
    judgingCriteria: [
      "Top 12-15 teams will proceed to round 2.",
      "Top 4-6 teams from round 2 will be selected for the final round. ",
      "The final winner will be decided based on the time consumed, money left with the team and percentage of completion of the project. ",
    ],
    contactDetails: [
      {
        name: "Anup Rai",
  ...
  },
  {
    ...
    venue: "Sambram",
    branch: "ISE",
    image: "/events/IS/generalquiz.jpg",
    smallDesc:
      "If you think you know it all and much more, this is the right place for you. Go ahead and unlock your knowledge at the speed of thought. ",
    fullDesc:
      "Get ready for a roller coaster ride into the intense world of quizzing. Far from classroom rote, this quiz will help you put your grey cells to the test. If you think you know it all and much more, this is the right place for you. Go ahead and unlock your knowledge at the speed of thought.",
    roundDetails: {
      round1: ["Pen and paper test consisting of general knowledge questions"],
      round2: [
        "This will be the final round consisting of various exciting elements.",
      ],
    },
    rules: [
      "On-spot registration is available ",
      "The use of electronic devices during the quiz is strictly prohibited and will result in the elimination of the team",
      "Round 1: Maximum of 3 people in a team o The teams that pass the cutoff will qualify for Round 2",
      "Round 2: Consists of three exciting rounds spanning various areas of general knowledge",
      " The rules shall be conveyed before each round by the quiz master.",
    ],
    judgingCriteria: [
      "The team with the highest score at the end will be declared the winner.",
      "The Quiz Masters' decisions will be final and binding in case of any discrepancy or dispute.",
    ],
    contactDetails: [
      {
        name: "Alden",
  ...
  },
  {
    ...
    smallDesc:
      "Do you have the itch to make a joke out of every possible scenario? If so, come showcase your skills because this event is just right for you!",
    fullDesc:
    ...
    roundDetails: {
      round1: [
        ...
        "The questions don't have to make sense or logically respond to one another; the trick is just to get another player to fall into the habit of automatically answering a question. Only one person from a team can participate.",
      ],
      "elimination round": [
        ...
        "The top 8 teams will advance to the final round.",
      ],
      round2: [
      ...
      round3: [
        "End Game The moderator randomly picks a scene and the roles will be assigned.",
    ...
    rules: [
      ...
      "Team members must be from the same collège.",
    ...
    judgingCriteria: [
      "Round 1: It's an elimination round. (If there are 30+ teams then there will be another elimination round.)",
      "Round 2: The 8 teams with the highest scores as given by the judge will advance to Round 3. ",
      "Round 3: The Final round is among the top 4 teams that advance to this round. Performances will be evaluated by the judge.",
    ],
    contactDetails: [
      {
        name: "Sahana Kulal",
  ...
  },
  {
    ...
    smallDesc:
      "You think you can make it through straight 60 seconds of speaking without any jerks while your opponents wait to pounce over you?",
    fullDesc:
      "All about the control of the mind over the mouth, you think you can make it through straight 60 seconds of speaking without any jerks while your opponents wait to pounce over you? Do you have what it takes to beat the pressure and silence your opponents? If yes, this is your cup of tea.",
    roundDetails: {
      round1: [
        "This will be an elimination round where participants will have to speak on the topic for a minute ",
      ],
      round2: ["Final buzzer round"],
    },
    rules: [
      "Participants must speak fluently",
      "Try not to stutter, stammer, speak too fast or be incoherent",
    ...
    judgingCriteria: [
      "JAM master's decision is final. You may try to convince him but not argue with his decision.",
    ],
    contactDetails: [
      {
...

  {
    ...
    venue: "NC 23",
    branch: "EEE",
    image: "/events/EE/KALAKAR.png",
    smallDesc:
      "They say a picture is worth a thousand words,then a film is worth a thousand timesmore. If you are an author whose novels are films, Kalakaar is where you should publish!",
    fullDesc:
      "Anything that can be written or thought of can be filmed. A theme will be given to the participating teams .",
    roundDetails: {
      round1: [
        "A theme will be given to the participating teams on the first day of the fest. The governing rules will be announced on the spot.",
      ],
      round2: [
        "Final-The short movie will be collected by the organizers and then the judicial process will take placed",
      ],
    },
    rules: [
...

  {
    ...
    venue: "NC 24, 25",
    branch: "ISE",
    image: "/events/IS/khaamoshh.jpg",
    smallDesc:
      "Do you have what it takes to express yourself without saying a word? ",
    fullDesc:
      "'Khaamoshh! is the perfect event for you to show your enacting skills. Come put your team of three to the ultimate test.",
    roundDetails: {
      "round 1": [
        "The Mind Fizz - Teams will be given a set of questions related to movies (Bollywood/ Hollywood /Sandalwood). Based on the scores, the top teams will qualify for the next round.",
      ],
      "round 2": [
        "Pictoword - A combination of pictures that form the movie name/ song name will be displayed on the screen.The participants must guess the word from the pictures they see on the screen into one word. Teams guessing the maximum number of movies qualify for the next round.",
      ],
      "round 3": [
        "Sun Saathiya! A Bollywood song or a famous dialogue is played to all the participants and they have to guess the movie. Teams guessing the maximum number of movies will qualify for the final round.",
      ],
      "round 4": [
        "(Final Round): Battle of the charade-Teams will be given movie titles(Bollywood / Hollywood) that must be presented to their partners in a chained manner.The team that has the highest score appears as the winner.",
      ],
    },
    rules: [
      "The use of cell phones or any other electronic devices is not permitted",
...

  {
    ...
    smallDesc:
      "Lazzerena is a tag game which allows amateur video game lovers to experience war zone scenario in real life.",
    fullDesc:
      "It is played with guns which emit infrared beams. Infrared sensitive sensors which are integ rat ed on jackets are worn by each player. The game will comprise of two teams and each team will try to knockout the opponent by firing on their respective sensors.",

    rules: [
      "The game will consist of at most 2 teams of 4 members each.",
...

  {
    ...
    smallDesc:
      "A rostrum where creativity meets madness, a chance to make an advertisement hilarious or sensitive. ",
    ...
    rules: [
      ...
      "The duration of the advertisement is 5 + 2 minutes",
...

  {
    ...
    fullDesc:
      "MELAS comprises questions ranging from Music, Entertainment , Literature, Arts and Sports. If you possess the required grey matter, then this event is meant for you.",
    roundDetails: {
      "round 1": [
        "Prelims will be a pen and paper round wherein participants need to write answers to a given set of questions. The top 6 scoring teams will move to the finals.",
      ],
      "round 2": [
        "Finals will be an audio and visual round and the team with the max score at the end of all rounds will be declared the winner",
      ],
    },

    rules: [
      "The event consists of two rounds - Prelims & Finals",
...

  {
    ...
    smallDesc:
      "A mega event, an alter-ego of a treasure hunt where you need to use your brains, wit, and wisdom. ",
    fullDesc:
      "We bring to you-  MISSION IMPOSSIBLE because the treasure is not easy to FIND. Isn't life a collection of weird quizzes with no answers to half the questions?",
    roundDetails: {
      "round 1": [
        "Preliminary round which involves puzzle solving and logical thinking will be conducted and the top 25% of  teams will proceed to the next round",
      ],
      "round 2": [
        "A game that involves the use of your analytical and cryptic skills will be held, wherein the top 8 teams will qualify for the finale.",
      ],
      "round 3": [
        "The final round is a treasure hunt where team has to solve a set of clues which will lead them to the final treasure.",
      ],
    },
    ...
    rules: [
      ...
      "The level of difficulty of the task will increase with the number of times the team asks for a hint.",
      "Each team has an allowance to ask for a maximum of 4 hint",
      "Four members make a team",
      "All four members should represent the same college",
      "On- spot registrations permitted",
...

  {
    ...
    smallDesc:
      "Open your eyes to a day when you're finally a celebrity not just in front of your mirror!",
    fullDesc:
      "Got the skills to speak up and convince your audience? Can't wait to face the barrage of questions thrown towards you? Step into their boots and bring your celeb A- game to the table.",
    roundDetails: {
      "round 1": [
        "Each participant must perform individually. General/ entertainment quiz",
      ],
      "round 2": ["The final round will be a mock press"],
    },

    rules: [
      "On-spot or pre- registrations can be done",
      "Candidates should be present at the venue on time",
      "Each participant will be given 10 minutes to prepare for their respective characters",
      "The participant has to make an introduction about their given personality",
      "After the introduction, the participants will be asked questions by the judges posed as journalists.",
...

  {
    ...
    smallDesc:
      "A painting or photo exhibition is traditionally a space in which art meets an audience.",
    fullDesc:
      " Paint and pixel is an event where we provide a platform for the artists and photographers of our college to showcase their talent.Art completes what nature cannot bring to a finish and a camera is the save button for the mind's eye. Attendees will be able to view the exhibits on display. If the artist is willing to sell his / her work, we provide a medium to do so. The exhibits will be on display on all four days of Incridea.",
    contactDetails: [
      {
        name: "Shraddha JR",
...

  {
    ...
    smallDesc:
      "Do you master the art of playing with perceptions or bringing your imagination to life? ",
    fullDesc:
      " The success of a presentation is judged not by the knowledge one conveys, but by what the audience receives. Panchatantram is a platform where you get to enthrall the world with your presentation skills.",
    roundDetails: {
      round1: [
        "This round is a pen and paper test which consists of 30 questions related to topics like problem- solving, logical reasoning, general knowledge and verbal abilities to be answered in 30 minutes.The top 10 teams to clear round 1 will be selected for round 2.",
      ],
      round2: [
        "This round is also a pen and paper test which consists of 20 questions that involve monitoring skills and visual clues to be answered in 20 minutes. The top 4 teams to clear round 2 will advance to round 3.",
      ],
      round3: [
        "This round is all about chart preparation.The main task employs the participant's professional skills and grasping power. The time duration is 60 minutes.",
      ],
    },

    rules: [
      "A team consists of 2 members.Any number of teams from a college can register for the event",
      "Use of the internet or any kind of reading materials/ text books is strictly prohibited",
      "Only students from the same college can form a team",
    ...
    judgingCriteria: [
      "The selection of teams for the final round will be based on the cutoff marks set by the judges",
  ...
  },
  {
    ...
    smallDesc:
      "Grab a person and a paintbrush and head on over to this face painting competition!",
    fullDesc:
      "In this age of filters and lenses where augmented reality has made changing our looks as simple as tapping a button, Prathibimb takes a step back to the drawing board. ",
    roundDetails: {
      round1: [
      ...
      round2: [
        "The qualified teams for round 2 will paint their fellow teammate based on the provided theme in 1.5 hours. The top teams with the best face painting will be announced as winners.",
      ],
    },
  ...
  },
  {
    ...
    rules: [
      "Any number of ent ries per college",
      "The team must have 2 members from the same college where only one has to paint.",
      "Participants should bring their own materials",
      "Brush, sponge, and glitter are allowed",
    ...
    judgingCriteria: [
      "Based on creativity, content, display, and overall presentation.",
    ],
  ...
  },
  {
    ...
    smallDesc:
      "I love argument, I love debate. I don't expect anyone just to sit there and agree with me, that's not their job - Margaret Tha tcher",
    fullDesc:
      "Do you agree with her? Then come and let your opinions speak louder than your voice in Prove Us Wrong. Armed with vocabulary and craft, stage awaits you motor mouths to set it all on fire.",
    roundDetails: {
      "round 1": [
        "Prelims- English aptitude and General knowledge questionnaire will be used for qualifications into the next round",
      ],

      "round 2 ": [
        "Mains - Topics will be given 5 minutes prior to  the round.One team speaks for the to pic while the other team speaks against(3 minutes each + 1 minute for conclusion)",
      ],
    },

    rules: [
      "A team should have a minimum of 1 and at most 2 members.",
    ...
    judgingCriteria: [
      "Participants will be judged based on their organization, clarity, reasoning, research, and speaking skills.",
    ],
    contactDetails: [
      {
        name: "Sujay Naik",
...

  {
    ...
    smallDesc:
      "Think your designs have what it takes to enthrall and stand out among countless others?",
    fullDesc:
      "Patterns and design are an integral part of our culture. Think your designs have what it takes to enthrall and stand out among countless others? Then this competition is for you!",
...

  {
    ...
    games: [
      ...
      },
      {
        ...
        registrationDetails: ["Rs 400/- per team"],
      },
      {
        name: "VALORANT",
        rules: [
      ...
      },
      {
        ...
        registrationDetails: ["Rs.80/- per participant"],
      },
      {
        name: "BGMI",
        rules: [
      ...
      },
      {
        ...
        registrationDetails: ["Rs.250/- per team", "Max 5+1 in a team"],
      },
      {
        name: "2 PLAYER GAMES",
        rules: [
  ...
  },
  {
    ...
    smallDesc:
      "A sequence of vocals thrumming to a beat, a chain of songs, and you're in for a melodious treat. ",
    fullDesc:
      "Presenting to you Riff-Off - an Antakshari with a twist. Come sing along because those who wish to sing always find a song.",
    roundDetails: {
      "Preliminary round": [
        "30 questions will be given with options. The maximum time allotted is 40 minutes .The top 8 teams will be selected for the next rounds.",
      ],
      "Round 1": [
        " English - Vinglish - In this round, the team has to guess the Bollywood song from its hilarious English translation.This is a buzzer round.The one to answer first, get the points.",
      ],
      "Round 2": [
        " Anthra - Mukhda - In this round, the team has to sing the song in vocals as asked by the judges. Mukhda is the initial line of the song and Anthra is the second stanza of the song.",
      ],
      "Round 3": [
        " Guess the movie name from the dialogue played. Each team will be played a different dialogue and they will gain points only if they answer correctly.",
      ],
      "Round 4": [
        " Prop round - The participants have to sing a song having the word of prop displayed on the screen.",
      ],
      "Round 5": [
        " A video of a song and audio of another song in reverse will be played simultaneously.Guess the movie name of these songs.The game will be played in the form of a buzzer round, and in case of ambiguity, the judges' decision will be final.",
      ],
    },
...

  {
    ...
    smallDesc:
      "Are you ready to get the best out of yourself as an individual and as a team member? Do you think you have what it takes to be the ultimate ROADIE? ",
    fullDesc:
      "An event that sees your potential as an individual as well as a group member having various rounds as mentioned below. The tasks would not be mentioned precisely as it would be best if kept a surprise.",
    roundDetails: {
      "ROUND 1": [
...

  {
    ...
    smallDesc:
      "Do you see the world around you in vivid colours? Does every ordinary occurrence play out differently in your imagination? ",
    fullDesc:
      "If you found yourself saying yes, then we've got the perfect event for you! Shark tank will tingle your senses and kick your creativity into gear.",
    roundDetails: {
      "Round 1: ": [
...

  {
    ...
    smallDesc:
      "An event to portray how erudite and witty you are to read between the lines. Do you have what it takes to unlock the SHER-LOCKED?",
    fullDesc:
      "Don your trench coats and magnifying glasses. Work your brain to its full potential as you journey through all the facts and information and emerge victoriously. An event to portray how erudite and witty you are to read between the lines. ",
    roundDetails: {
      "Round 1: ": [
  ...
  },
  {
    ...
    fullDesc:
      "You can look at a picture for a week and never think of it for a second. You can also look at a picture for a second and think of it all your life. Shutter up is an event for all photo enthusiasts to show the world a story that cannot be put into words.",
    roundDetails: {
      "Round 1:": [
...

  {
    ...
    smallDesc:
      "Skill in riding is not about how fast you can go, but about how steady you are in the trickiest roads. ",
    fullDesc:
      "For all the bike enthusiasts, we present to you the SLOW BIKE RACE. It's your road. Others can ride it with you, not for you. For all the bike enthusiasts, we present to you- the Slow Bike Race, where for once, coming last is in your favour.",
    roundDetails: {
      "Round 1": [
        "Participants have to ride the motorcycle on a plain track, and those reaching the finish line at the last will be selected for the next round",
      ],
      "Round 2": [
        "The shortlisted participants are required to overcome obstacles to reach the finish line.The last one to do so wins.",
      ],
    },
...

  {
    ...
    smallDesc:
      "Talent is a one-of-a-kind skill that sets you apart from the rest of the pack. Everyone is born with it, but not everyone recognises it. ",
    fullDesc:
      "Talent House X is a forum for amateur artists to display their talents in a variety of genres, including singing, dance, comedy, novelty acts and more. So, if you've discovered the X factor in you, then this is the right platform to show case your hidden 'X' quotient on stage and wow the crowd!",
    roundDetails: {
      "Round 1": [
...

  {
    ...
    smallDesc:
      "Not every thing is about you kids, make way for your lecturers to show their unseen skills this Incridea!",
    fullDesc:
      "Not every thing is about you kids, make way for your lecturers to show their unseen skills this Incridea!",
    roundDetails: {
      "Round 1": [
        "Figure it out- 15 - 20 questions comprising brain teasers, guess the missing letter, find the words, etc., will be asked.The time given for solving it is 20 minutes.",
      ],
      "Round 2": [
        "Take a guess- Participants will be shown pictures of eminent personalities and  will be asked to figure out their contributio n or vice versa.Along with this, song tunes or voices of the personalities will be played and participants have to guess which song or which celebrity it is and similar questions.",
      ],
    },
...

  {
    ...
    fullDesc:
      "Do you have what it takes to move the hearts of the masses with your voice? Then it is time to bring out your inner Nightingale.",
...

  {
    ...
    fullDesc:
      "The escape room is an event that unleashes the detective in you. With a few technical skills and a keen sense of observation, you have to escape from the grasp of your kidnapper. Your basic chemistry and biology knowledge and your stamina will be the key to helping solve the mystery. ",
    roundDetails: {
      "Round 1": [
        "Questions related to basic chemistry and biology will be asked with a few brain teasers and puzzles. 30 minutes will be given to complete the questionnaire. The top 10 teams will be selected based on the highest scores.",
      ],
      "Round 2": [
        "This round will be a scavenger hunt where the teams will be gathering clues and protocols for the final round. Only 3 teams that can gather all the clues will be allowed to proceed to the final round",
      ],
      "Round 3": [
        "The teams have to solve puzzles and perform certain basic chemistry experiments to solve the mystery and escape from the room.",
      ],
    },
...

  {
    ...
    smallDesc:
      'Do you know a little more Biology than "Mitochondria is the powerhouse of the cell" and a little more Chemistry than "a mole is equal to 6.022* 10"^23 atoms "?',
    fullDesc:
      "Perplex awaits you. Come push your knowledge, task handling cap abilities, and time management skills to the limit",
    roundDetails: {
      "Round 1": [
        "Quiz comprising of questions related to chemistry and biology. The top 8 teams will be selected for the next round",
      ],
      "Round 2": [
        "Small tasks related to basic lab instruments. Based on the accuracy and performance of the task, three teams shall proceed to the final round",
      ],
      "Round 3": [
        "A time-based round. Teams will be given a set of experiments to be completed at the earliest. The team which completes all the given experiments first shall be the winner",
      ],
    },
  ...
  },
  {
    ...
    smallDesc:
      "Show off your hacking skills and flex your problem solving skills",
    fullDesc:
      "Capture the Flag is the platform to show off your hacking skills and flex your problem solving skills through a series of problems in the Cryptography, Stenography, Binary Exploitation, Web Exploitation, Forensics, Reverse Engineering, Programming, Packet Analysis and some Miscellaneous categories.",
    roundDetails: {
      "Round 1": [
        " Jeopardy-style CTF: A couple of questions (tasks) in range of categories: Cryptography, Stenography, Binary Exploitation, Web Exploitation, Forensics, Reverse Engineering, Programming, Packet Analysis, Miscellaneous will be asked. Teams with the most points will move forward to Round 2. Attacking the other teams will lead to direct disqualification.",
      ],
      "Round 2": ["-"],
    },
...

  {
    ...
    smallDesc:
      "All you need is some technical knowledge, swift responses, and a great companion!",
    fullDesc:
      "Techtainment is an event that will keep you on your toes while storming your technical cap abilities. ",
    roundDetails: {
      "Round 1": [
...

  {
    ...
    smallDesc:
      'Ever looked at a corporate website and thought "I could have done that". Well, here\'s your chance to prove that in our all- new web piracy web competition.',
    fullDesc:
      'Ever looked at a corporate website and thought "I could have done that". Well, here\'s your chance to prove that in our all- new web piracy web competition.',
    roundDetails: {
      "Round 1": [
        "E - Talaash(Tech Hunt) : Participants need to solve the given puzzle and find the file name in which the code is present whose output leads to the qualification ticket. The first 20 teams to find the ticket will be qualified for the next round.",
      ],
      "Round 2": [
        "Clone the page : A static web page will be displayed. Participants need to recreate it within the given time limit of 90 minutes.",
      ],
    },
...

  {
    ...
    smallDesc:
      "A step to test your skills of past by constructing your creativity in present. Here's a challenge to live your childhood again, ask yourself Can you fix it? We present to you BOB THE BUILDER.",
    fullDesc:
      "Each team consist of 3 members. Consists of three rounds. All required materials will be provided.",
    roundDetails: {
      "Round 1": [
        "Preliminary Round -25 aptitude questions will be given. Time allotted is 20 minutes",
      ],
      "Round 2": [
        "Eliminator Round- Model a staircase using ice - cream sticks for minimum height. Aesthetics and timing will be the judging criteria.Top 7 teams will qualify for the final round.",
      ],
      "Round 3": [
...

  {
    ...
    smallDesc:
      '"Efforts and hard work construct the bridge that connects your dream to reality", If you think  you can build the lightest bridge with the highest structural efficiency this is the right place to be!',
    fullDesc:
      "Each team consist of 3 members. Consists of three rounds. All required materials will be provided.",
    roundDetails: {
      "Round 1": [
        "Preliminary Round -Each team should consist of 3 members. 25 MCQ questions will be given on the spot. Time allotted is 15 minutes.Top 12 teams will qualify for the next round ",
      ],
      "Round 2": [
        "Puzzle hunt - The participants will be given certain crosswords followed by tasks to perform. Timings will be the main judging criteria.Top 8 teams will qualify for the final round",
      ],
      "Round 3": [
...

  {
    ...
    smallDesc:
      "It's always the small pieces that make the big pictures. Here is a chance to you to solve the puzzles and to bring out the ideas in a paper by using your creative and competitive thinking skills.",
    fullDesc:
      '"To expect the unexpected shows thoroughly a modern intellect."Do you love writing research papers and presenting them nonchalantly? lntellectium is open now!',
    roundDetails: {
      "Round 1": [
...

  {
    ...
    roundDetails: {
      "Round 1": [
        "A race bot will have to travel in a terrain with obstacles like humps, elevation and the bot to cross the finish line the quickest will be qualified to the next round. If a bot topples or goes out of the track, then it needs to start over from the previous checkpoint.",
      ],
      "Round 2": [
        "A bot will face several difficult terrains and will have to perform few tasks, and based on the time taken to cross the finish line performing all the tasks, the winner will be declared",
      ],
    },
  ...
  },
  {
    ...
    smallDesc:
      "Are you an electronics geek? Do you want to test your circuit building skills and be a winner? ",
    fullDesc:
      "Wired! is the place you should be. Come, show us what you've got.",
    roundDetails: {
      "Round 1": [
        "The Prelims- A pen - paper test consisting of aptitude and technical questions. There will be 30 questions to be solved in a time interval of 30 mins. The top 10 highest scoring teams will qualify for the next round.",
      ],
      "Round 2": [
        "Circuit Fix-In this round, selected teams will be given with the circuits and Verilog codes. The teams have to analyze and debug the same to get the right output.The teams that complete round 2 can proceed with the 3rd round.",
      ],
      "Round 3": [
        "Optimum- The teams will be given with a problem statement on Opamp circuit that needs to be designed and simulated using LT spice in the simplest way possible.The team which gets the optimal solution within the earliest possible time will be the winner.",
...

  {
    ...
    fullDesc:
      ". If you can stay cool while burning and running programs using microcont rollers and Arduino, Burn and Run awaits you!",
    roundDetails: {
      "Round 1": [
        "35 questions about the microcon troller will be given to the participants. The time allotted is 45 minutes.",
      ],
      "Round 2": [
        "A problem question related to Arduino interfacing will be given. Participants are expected to write the code using Arduino IDE and burn the hex file to get the desired output. Three hours are allotted for this round.",
      ],
    },
...

  {
    ...
    smallDesc:
      "Are you the reputed regulator for the fluctuations in circuit- related problems in your friends' gang? If yes, then come to Electricuit It!",
    fullDesc:
      "Are you the reputed regulator for the fluctuations in circuit- related problems in your friends' gang? If yes, then come to Electricuit It!",
    roundDetails: {
      "Round 1": [
        "This round is about a crossword puzzle on Electronics. The top 10 teams to solve it within 25 minutes will be selected for the next round.",
      ],
      "Round 2": [
        "This round is a paper and pen test where the teams will be given 5 faulty circuits. They have to rectify the mistakes in the circuit to get the relevant output within 15 minutes.",
      ],
      "Round 3": [
        "This round consists of circuit designing. The components will be provided to the participants who must design a circuit for the given problem using only the components provided. The total time duration is 90 minutes.",
      ],
    },
...

  {
    ...
    smallDesc:
      "Are you a coding wizard? Or a person who loves to code? If yes, then Code Studio is a perfect platform for you",
    fullDesc:
      "Consisting of four rounds in total, each round is going to be bigger and better. Grab this opportunity and test your coding skills with Code Studio.",
    roundDetails: {
      "Round 1": [
      ...
      "Round 2": [
        " Blind Coding - A simple program is given to each team.",
      ...
      "Round 3": [
        " Finding Bugs- The teams ore provided with the program or snapshots of it, which contains bugs or error messages.",
      ...
      "Round 4": [
        " Betting On Your Code -Each team will be provided with certain points, and at a time one question will be displayed to all the teams",
...

  {
    ...
    fullDesc:
      'Building a website is easy, designing one takes skill. A perfect opportunity for all the Web development enthusiasts !! Do you have an aptitude for designing and coding? Then "Webbed" is perfectly suited to test your designing and coding skills. Consisting  of three rounds,  put  your team of two to the ultimate test.',
    roundDetails: {
      "Round 1": [
...

  {
    ...
    smallDesc:
      "Do you think you can bring life to the heart of the vehicle? This is a great opportunity for all the motor- heads out there to get your engine know-how tested.",
    fullDesc:
      "A team should consist of 2-3 members who are of the same college. An individual should be a member of only one team .All the required tools for overhaul will be provided",
    roundDetails: {
      "Round 1": [
      ...
      "Round 3": [
        "Involves fixing an already overhauled engine. A video will be shown on how to fix the already overhauled engine. The participants have to carefully observe and assemble it according to the instructions. The teams will have to assemble the engine with the smallest number of errors in the least amount of time",
      ],
    },
    // "rules": [
...

  {
    ...
    smallDesc:
      "Beckham who? Get those motors smoking; remember the robots from Robowars? Now they play soccer.",
    fullDesc:
      "Beckham who? Get those motors smoking; remember the robots from Robowars? Now they play soccer.",
    roundDetails: [
      "In the  beginning, a toss will decide the first hold over the ball.The winner of the toss will get possession of the ball at the center of the arena, whereas the opponent will have to defend the post.",
