...
function Registration() {
    ...
    const submitData = async (events) => {
        ...
        if (name && email && message) {
            ...
            const res = await fetch("https://finiteloop-club-default-rtdb.firebaseio.com/newResigered.json",
                {
                    method: "POST",
                    headers: {
            ...
            <div className="w-7/12 my-8 mx-auto">
                <form className='text-left' method='POST' >
                    ...
                    <div className="relative z-0 w-full mb-6 group ">
                        ...
                        <label for="message" className="peer-focus:font-medium absolute text-sm text-gray-500   duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-orange-600   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 ">What are Your expections from us </label>
                    </div>
